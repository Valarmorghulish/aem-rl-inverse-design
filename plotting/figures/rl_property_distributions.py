...
"""Plot RL property distributions for all reported polymer families."""
...
DATASETS = {
    "PAEKS": {
        "folder": "rl_replay_plots_50PAEKS",
    ...
    "PBF": {
        "folder": "rl_replay_plots_50PBF",
        "file_pattern": "checkpoint_iter_{iter}_valid_samples_cumulative.csv",
        "iters": [10, 20, 30, 40],
    },
    "PPO": {
        "folder": "rl_replay_plots_50PPO",
        "file_pattern": "checkpoint_iter_{iter}_valid_samples_cumulative.csv",
        "iters": [10, 20, 30, 40, 50],
    },
    "PAP": {
        "folder": "rl_replay_plots_50PAP",
        "file_pattern": "checkpoint_iter_{iter}_valid_samples_cumulative.csv",
        "iters": [10, 20, 30],
    },
    "PAEK": {
