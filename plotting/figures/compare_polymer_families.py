...
"""Compare Pretrain, Fine-tune, PAEK, PAEKS, and PAES distributions."""
...
SOURCES = {
    ...
    "PAEK": os.path.join(ROOT, "PAEK", "PAEK_all_constrained.csv"),
    "PAEKS": os.path.join(ROOT, "PAEKS", "PAEKS_all_constrained.csv"),
    "PAES": os.path.join(ROOT, "PAES", "PAES_all_constrained.csv"),
}

# --- Plot groups - each tuple defines one figure -----------------------------
PLOT_GROUPS = [
    ("PAEK", ["Pretrain", "Fine-tune", "PAEK"]),
    ("PAEKS", ["Pretrain", "Fine-tune", "PAEKS"]),
    ("PAES", ["Pretrain", "Fine-tune", "PAES"]),
]
